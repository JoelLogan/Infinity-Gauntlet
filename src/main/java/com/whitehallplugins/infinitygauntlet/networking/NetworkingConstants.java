...
public final class NetworkingConstants {
    ...
    public static final Identifier GAUNTLET_PACKET_ID = Identifier.of(MOD_ID, "update");
    public static final Identifier VERSION_PACKET_ID = Identifier.of(MOD_ID, "version");
